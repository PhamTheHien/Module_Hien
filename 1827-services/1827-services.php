...
<div class="type-1827 pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
        <img width="100%" src ="images/dev.jpg" alt="">
            </div>
            <div class="col-sm-6 ">
            <div class="more text-left mb-5">
                    <h3 class=" position-relative mb-5">Web development</h3>
                </div>
                <h5>Quisque quis ex mattis, euismod mauris lorem ipsum eget, scelerisque sapien.​</h5>
